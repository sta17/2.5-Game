@icon("res://assets/images/Public Domain/pixel-boy/node_3D/icon_money_bag.png")
...
@onready var sprite:Sprite3D = $Geometry/Sprite3D
...
func Collect(player):
	...
	is_pickable = false
	player.interact_message_status_change(false)
	queue_free()
